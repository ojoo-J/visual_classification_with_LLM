...
hparams['gpt_model'] = 'gpt-4o' # baseline, gpt-3.5-turbo, gpt-4o
hparams['descriptor_fname'] = 'descriptors_imagenet_with_related_words' # descriptors_imagenet, descriptors_imagenet_with_related_words
...
IMAGENET_DIR = '/data2/youngju/clip_classifier/ImageNet/' # REPLACE THIS WITH YOUR OWN PATH
IMAGENETV2_DIR = '/proj/vondrick/datasets/ImageNetV2/' # REPLACE THIS WITH YOUR OWN PATH
OOD_DIR = '/data2/youngju/visual_classification_with_LLM/data/imagenet-a/' # REPLACE THIS WITH YOUR OWN PATH
CUB_DIR = '/data/CUB_200_2011' # REPLACE THIS WITH YOUR OWN PATH
EUROSAT_DIR = ''
FOOD101_DIR = ''
PETS_DIR = ''
DTD_DIR = ''
...
if hparams['dataset'] == 'imagenet':
    if hparams['dataset'] == 'imagenet':
        ...
        if hparams['descriptor_fname'] is None:
            hparams['descriptor_fname'] = 'descriptors_imagenet_with_related_words' # descriptors_imagenet_with_related_words
...
elif hparams['dataset'] == 'ood':
    # load CUB dataset
    hparams['data_dir'] =pathlib.Path(OOD_DIR)
    dataset = torchvision.datasets.ImageFolder(hparams["data_dir"], transform=tfms)
    classes_to_load = None
...
hparams['descriptor_fname'] = f'/data2/youngju/visual_classification_with_LLM/descriptors/{hparams["gpt_model"]}/' + hparams['descriptor_fname']
