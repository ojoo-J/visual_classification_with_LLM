...
print("Evaluating...")
lang_accuracy_metric = torchmetrics.Accuracy(task='multiclass', num_classes=len(dataloader.dataset.classes)).to(device)
lang_accuracy_metric_top5 = torchmetrics.Accuracy(task='multiclass', num_classes=len(dataloader.dataset.classes), top_k=5).to(device)

clip_accuracy_metric = torchmetrics.Accuracy(task='multiclass', num_classes=len(dataloader.dataset.classes)).to(device)
clip_accuracy_metric_top5 = torchmetrics.Accuracy(task='multiclass', num_classes=len(dataloader.dataset.classes), top_k=5).to(device)
